...
import { Search, ChevronRight, Edit, Building } from 'lucide-react';
      ...
      <div className="bg-white rounded-lg shadow-sm border">
        <div className="text-center py-12 text-pmo-gray">
          ...
          <p className="text-lg mb-2">
            {termoBusca || filtrosAplicados ? 'Nenhuma mudança encontrada para os filtros aplicados' : 'Nenhuma mudança encontrada'}
          </p>
          <p className="text-sm">
            {termoBusca || filtrosAplicados ? 'Tente alterar os filtros ou termos da busca' : 'Comece criando sua primeira solicitação de mudança'}
          </p>
        </div>
      </div>
    );
